    ...
    <div className="about--container--description">
      <div className="about--container--description-text">
        <div>
          <h2>¿Quién soy?</h2>
          <p>
            Soy Jose Montenegro un fronted developer, estudiante de informatica
            y autodidacta, apacionado por la tecnologia y la educacion..
          </p>
          <h2>Intereses</h2>
          <p>
          ...
          <p>
            ...
            adquirir experiencia en proyecto, como tambien aprender
            constantemete nuevas tecnologias y formas de mejorar mis
            habilidades.
          </p>
        </div>
      </div>
