...
export const PORTFOLIO_DATA = {
  personal: {
    ...
    bio: "Especialista en sistemas distribuidos de alta concurrencia, arquitecturas orientadas a eventos e ingeniería de Agentes de IA en tiempo real. Con experiencia directa integrando equipos de ingeniería para plataformas críticas de escala como Yape (vía Arkano), Bancolombia (vía PRAGMA) y KasNet (vía QDS), y formando a más de 1,500 ingenieros de software.",
  ...
  caseStudies: [
    ...
    },
    {
      ...
      client: "Plataforma Yape (Asignado vía Arkano)",
      role: "Senior Backend Engineer (Equipo Transaccional)",
      period: "2026 - Presente",
      summary: "Integración del equipo backend de ingeniería asignado por Arkano para el desarrollo y optimización de microservicios transaccionales de alta concurrencia para Yape (+15M usuarios).",
    ...
    },
    {
      ...
      client: "Bancolombia Guatemala (Asignado vía PRAGMA)",
      role: "Cloud Software Engineer (Equipo Core)",
      period: "2024 - 2025",
      summary: "Integración del equipo cloud engineering asignado por PRAGMA para la modernización de componentes bancarios hacia arquitectura Serverless en AWS utilizando Arquitectura Hexagonal y orquestación de eventos.",
    ...
    },
    {
      ...
      client: "KasNet (Asignado vía QDS)",
      role: "Software Engineer & Tech Interviewer",
      period: "2025 - 2026",
      summary: "Participación en el equipo backend asignado por QDS para el diseño e implementación de microservicios de pagos y corresponsalía bancaria con patrón CQRS y comunicación de eventos mediante Apache Kafka.",
